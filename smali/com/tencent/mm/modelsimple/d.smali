...
.method public static aD(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 251
    const-string v0, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"
    ...
    .line 261
    const-string v1, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"
    ...
    .line 272
    const-string v3, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"

    const-string v4, "Have got name from profile, name is %s"
    ...
    invoke-static {p0, v1}, Lcom/tencent/mm/modelsimple/d;->r(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "Have got name from contacts, name is %s"
...
.method public static aE(Landroid/content/Context;)Landroid/graphics/Bitmap;
    .locals 13
    .annotation build Landroid/annotation/TargetApi;
        value = 0xe
    .end annotation
    ...
    .line 341
    const-string v4, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"
    ...
    .line 344
    invoke-static {v3}, Lcom/tencent/mm/modelsimple/d;->jQ(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 396
    invoke-static {v2}, Lcom/tencent/mm/modelsimple/d;->jQ(Ljava/lang/String;)Landroid/graphics/Bitmap;
...
.method private static jQ(Ljava/lang/String;)Landroid/graphics/Bitmap;
    .locals 11
    ...
    const-string v2, "Get bitmap by HTTPS request. url = %s"
    ...
    .line 457
    :try_start_1
    invoke-virtual {v2}, Lcom/tencent/mm/network/ap;->getInputStream()Ljava/io/InputStream;
    :try_end_1
    ...
    .line 464
    :try_start_2
    const-string v5, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"
    ...
    .line 465
    :try_start_3
    invoke-virtual {v2}, Lcom/tencent/mm/network/ap;->disconnect()V
    ...
    .line 494
    const-string v2, "!32@/B4Tb64lLpLSOpQlr7qYXRHsd4oF45L0"
...
.method public static q(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "Get phone number. country code : %s"
    ...
    .line 76
    invoke-static {v1, v6}, Lcom/tencent/mm/sdk/platformtools/ak;->bT(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "get num : %s, extract country code  : %s, iso : %s"
    ...
    const-string v2, "after deal, the num is %s"
    ...
    const-string v2, "get line number got exception"
    ...
    invoke-static {v1}, Lcom/tencent/mm/compatible/i/h;->cw(I)Z
    ...
    const-string v5, "The phone count of the profile is "
    ...
    .line 156
    invoke-static {v11}, Lcom/tencent/mm/sdk/platformtools/bl;->lr(Ljava/lang/String;)Z
    ...
    .line 186
    invoke-static {v10, v6}, Lcom/tencent/mm/sdk/platformtools/ak;->bT(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "get phone num : %s, extract country code  : %s iso : %s"
    ...
    const-string v1, "after deal, the phone num is %s"
...
.method private static r(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "Get contactId by email, email = %s"
    ...
    const-string v3, "getContactIdByEmail error"
