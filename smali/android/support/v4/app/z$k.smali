...
.method public final a(Landroid/support/v4/app/z$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 542
    iget-object v0, p1, Landroid/support/v4/app/z$d;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/z$d;->cW:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/z$d;->cE:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/z$d;->cC:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/z$d;->cF:I

    iget-object v7, p1, Landroid/support/v4/app/z$d;->cA:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/z$d;->cB:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/z$d;->cD:Landroid/graphics/Bitmap;
