...
.field final aQ:Landroid/support/v4/app/j;

.field final aR:Landroid/support/v4/app/h;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->aR:Landroid/support/v4/app/h;
...
.method final b(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/u;->aC:Z
...
.method final c(Ljava/lang/String;)Landroid/support/v4/app/u;
    .locals 1
    ...
    .line 880
    iput-object p0, v0, Landroid/support/v4/app/u;->at:Landroid/support/v4/app/FragmentActivity;
...
.method final c(Z)V
    ...
    .line 774
    iput-boolean p1, p0, Landroid/support/v4/app/FragmentActivity;->aC:Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->aL:Landroid/support/v4/app/u;

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v4/app/FragmentActivity;->aC:Z
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 158
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    iget-object v1, v1, Landroid/support/v4/app/j;->bi:Ljava/util/ArrayList;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->aR:Landroid/support/v4/app/h;

    invoke-virtual {v0, p0, v2, v1}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/FragmentActivity;Landroid/support/v4/app/h;Landroid/support/v4/app/Fragment;)V
    ...
    .line 211
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$b;->bd:Ljava/util/HashMap;
    ...
    .line 215
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    if-eqz v0, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity$b;->bc:Ljava/util/ArrayList;

    :goto_0
    invoke-virtual {v3, v2, v0}, Landroid/support/v4/app/j;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 249
    sget-object v2, Landroid/support/v4/app/FragmentActivity$a;->aY:[I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/j;->b(I)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v5}, Landroid/support/v4/app/j;->d(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/app/j;->b(I)Landroid/support/v4/app/Fragment;
    ...
    :goto_1
    iput v1, v4, Landroid/support/v4/app/Fragment;->aw:I

    .line 282
    iput v3, v4, Landroid/support/v4/app/Fragment;->ax:I

    .line 283
    iput-object v5, v4, Landroid/support/v4/app/Fragment;->ay:Ljava/lang/String;

    .line 284
    iput-boolean v7, v4, Landroid/support/v4/app/Fragment;->ap:Z

    .line 285
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    iput-object v1, v4, Landroid/support/v4/app/Fragment;->as:Landroid/support/v4/app/j;

    .line 286
    iget-object v1, v4, Landroid/support/v4/app/Fragment;->ae:Landroid/os/Bundle;

    iput-boolean v7, v4, Landroid/support/v4/app/Fragment;->aF:Z

    .line 287
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    invoke-virtual {v1, v4, v7}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;Z)V
    ...
    .line 289
    :cond_7
    iget-boolean v4, v1, Landroid/support/v4/app/Fragment;->ap:Z
    ...
    .line 299
    :cond_8
    iput-boolean v7, v1, Landroid/support/v4/app/Fragment;->ap:Z

    .line 303
    iget-boolean v3, v1, Landroid/support/v4/app/Fragment;->aC:Z

    if-nez v3, :cond_9

    .line 304
    iget-object v3, v1, Landroid/support/v4/app/Fragment;->ae:Landroid/os/Bundle;

    iput-boolean v7, v1, Landroid/support/v4/app/Fragment;->aF:Z

    .line 306
    :cond_9
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    invoke-virtual {v3, v1}, Landroid/support/v4/app/j;->f(Landroid/support/v4/app/Fragment;)V
...
.method protected onDestroy()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/FragmentActivity;->c(Z)V
...
.method protected onPause()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/FragmentActivity;->an:Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 493
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentActivity;->aT:Z

    if-eqz v0, :cond_0

    .line 494
    invoke-virtual {p0, v6}, Landroid/support/v4/app/FragmentActivity;->c(Z)V

    .line 497
    :cond_0
    iget-object v7, p0, Landroid/support/v4/app/FragmentActivity;->aQ:Landroid/support/v4/app/j;

    iget-object v0, v7, Landroid/support/v4/app/j;->bi:Ljava/util/ArrayList;
    ...
    iget-boolean v2, v0, Landroid/support/v4/app/Fragment;->aB:Z
    ...
    iput-boolean v6, v0, Landroid/support/v4/app/Fragment;->aC:Z

    iget-object v2, v0, Landroid/support/v4/app/Fragment;->ai:Landroid/support/v4/app/Fragment;
    ...
    :goto_1
    iput v2, v0, Landroid/support/v4/app/Fragment;->aj:I

    sget-boolean v2, Landroid/support/v4/app/j;->DEBUG:Z
    ...
    .line 509
    iget-boolean v7, v3, Landroid/support/v4/app/u;->aC:Z
    ...
    .line 512
    :cond_6
    invoke-virtual {v3}, Landroid/support/v4/app/u;->L()V

    .line 513
    iget-object v7, p0, Landroid/support/v4/app/FragmentActivity;->aW:Ljava/util/HashMap;

    iget-object v3, v3, Landroid/support/v4/app/u;->ag:Ljava/lang/String;
    ...
    .line 523
    iput-object v5, v0, Landroid/support/v4/app/FragmentActivity$b;->aZ:Ljava/lang/Object;

    .line 524
    iput-object v5, v0, Landroid/support/v4/app/FragmentActivity$b;->ba:Ljava/lang/Object;

    .line 525
    iput-object v5, v0, Landroid/support/v4/app/FragmentActivity$b;->bb:Ljava/util/HashMap;

    .line 526
    iput-object v1, v0, Landroid/support/v4/app/FragmentActivity$b;->bc:Ljava/util/ArrayList;

    .line 527
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->aW:Ljava/util/HashMap;

    iput-object v1, v0, Landroid/support/v4/app/FragmentActivity$b;->bd:Ljava/util/HashMap;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/j;->w()Landroid/os/Parcelable;
...
.method protected onStart()V
    ...
    .line 551
    iput-boolean v2, p0, Landroid/support/v4/app/FragmentActivity;->aT:Z

    .line 552
    iput-boolean v2, p0, Landroid/support/v4/app/FragmentActivity;->aU:Z
    ...
    .line 555
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentActivity;->aS:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/app/j;->bu:Z
    ...
    new-array v4, v0, [Landroid/support/v4/app/u;
    ...
    .line 585
    iget-boolean v0, v5, Landroid/support/v4/app/u;->aC:Z
    ...
    :cond_3
    iput-boolean v2, v5, Landroid/support/v4/app/u;->aC:Z

    iget-object v0, v5, Landroid/support/v4/app/u;->cb:Landroid/support/v4/c/d;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/c/d;->valueAt(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/u$a;

    iget-boolean v6, v0, Landroid/support/v4/app/u$a;->aC:Z

    if-eqz v6, :cond_5

    sget-boolean v6, Landroid/support/v4/app/u;->DEBUG:Z

    if-eqz v6, :cond_4

    new-instance v6, Ljava/lang/StringBuilder;

    const-string v7, "  Finished Retaining: "
    ...
    :cond_4
    iput-boolean v2, v0, Landroid/support/v4/app/u$a;->aC:Z

    iget-boolean v6, v0, Landroid/support/v4/app/u$a;->cd:Z

    iget-boolean v7, v0, Landroid/support/v4/app/u$a;->ck:Z
    ...
    iget-boolean v6, v0, Landroid/support/v4/app/u$a;->ci:Z

    if-eqz v6, :cond_6

    iget-boolean v6, v0, Landroid/support/v4/app/u$a;->cl:Z

    if-nez v6, :cond_6

    iget-object v6, v0, Landroid/support/v4/app/u$a;->ch:Landroid/support/v4/content/b;

    iget-object v7, v0, Landroid/support/v4/app/u$a;->mData:Ljava/lang/Object;

    invoke-virtual {v0, v6, v7}, Landroid/support/v4/app/u$a;->a(Landroid/support/v4/content/b;Ljava/lang/Object;)V
    ...
    .line 567
    :cond_7
    iget-boolean v0, p0, Landroid/support/v4/app/FragmentActivity;->aN:Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/FragmentActivity;->c(Ljava/lang/String;)Landroid/support/v4/app/u;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->aL:Landroid/support/v4/app/u;
    ...
    iget-boolean v0, v0, Landroid/support/v4/app/u;->cd:Z
    ...
    .line 586
    :cond_8
    invoke-virtual {v5}, Landroid/support/v4/app/u;->K()V
...
.method public final p()Landroid/support/v4/app/i;
    .locals 1
