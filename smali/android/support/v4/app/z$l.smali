.class final Landroid/support/v4/app/z$l;
...
.method public final a(Landroid/support/v4/app/z$d;)Landroid/app/Notification;
    ...
    iget-object v1, v0, Landroid/support/v4/app/z$d;->mContext:Landroid/content/Context;

    move-object/from16 v0, p1

    iget-object v2, v0, Landroid/support/v4/app/z$d;->cW:Landroid/app/Notification;

    move-object/from16 v0, p1

    iget-object v3, v0, Landroid/support/v4/app/z$d;->cy:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v4, v0, Landroid/support/v4/app/z$d;->cz:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v5, v0, Landroid/support/v4/app/z$d;->cE:Ljava/lang/CharSequence;

    move-object/from16 v0, p1

    iget-object v6, v0, Landroid/support/v4/app/z$d;->cC:Landroid/widget/RemoteViews;

    move-object/from16 v0, p1

    iget v7, v0, Landroid/support/v4/app/z$d;->cF:I

    move-object/from16 v0, p1

    iget-object v8, v0, Landroid/support/v4/app/z$d;->cA:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v9, v0, Landroid/support/v4/app/z$d;->cB:Landroid/app/PendingIntent;

    move-object/from16 v0, p1

    iget-object v10, v0, Landroid/support/v4/app/z$d;->cD:Landroid/graphics/Bitmap;

    move-object/from16 v0, p1

    iget v11, v0, Landroid/support/v4/app/z$d;->cK:I

    move-object/from16 v0, p1

    iget v12, v0, Landroid/support/v4/app/z$d;->cL:I

    move-object/from16 v0, p1

    iget-boolean v13, v0, Landroid/support/v4/app/z$d;->cM:Z
