...
.field protected he:Landroid/view/LayoutInflater;

.field protected ii:Landroid/support/v7/internal/view/menu/g;

.field protected kG:Landroid/content/Context;

.field protected kH:Landroid/view/LayoutInflater;
...
.field protected kL:Landroid/support/v7/internal/view/menu/p;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 57
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/c;->kG:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kH:Landroid/view/LayoutInflater;

    .line 59
    iput p2, p0, Landroid/support/v7/internal/view/menu/c;->kJ:I

    .line 60
    iput p3, p0, Landroid/support/v7/internal/view/menu/c;->kK:I
...
.method public a(Landroid/support/v7/internal/view/menu/i;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 178
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kH:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/internal/view/menu/c;->kK:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/g;)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/c;->he:Landroid/view/LayoutInflater;

    .line 67
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/c;->ii:Landroid/support/v7/internal/view/menu/g;
...
.method public a(Landroid/support/v7/internal/view/menu/g;Z)V
    ...
    .prologue
    .line 204
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kI:Landroid/support/v7/internal/view/menu/o$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/o$a;)V
    ...
    .prologue
    .line 150
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/c;->kI:Landroid/support/v7/internal/view/menu/o$a;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/p;
    ...
    .prologue
    .line 71
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kL:Landroid/support/v7/internal/view/menu/p;
    ...
    iget v1, p0, Landroid/support/v7/internal/view/menu/c;->kJ:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kL:Landroid/support/v7/internal/view/menu/p;

    .line 73
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/c;->kL:Landroid/support/v7/internal/view/menu/p;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/c;->ii:Landroid/support/v7/internal/view/menu/g;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/internal/view/menu/c;->m(Z)V
...
.method public m(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/g;->bW()V

    .line 92
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/c;->ii:Landroid/support/v7/internal/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/internal/view/menu/g;->bV()Ljava/util/ArrayList;
    ...
    invoke-interface {v2}, Landroid/support/v7/internal/view/menu/p$a;->bv()Landroid/support/v7/internal/view/menu/i;
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/c;->kL:Landroid/support/v7/internal/view/menu/p;
...
.method public final setId(I)V
    ...
    .prologue
    .line 233
    iput p1, p0, Landroid/support/v7/internal/view/menu/c;->ce:I
