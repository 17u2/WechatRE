...
.field private jT:Landroid/support/v7/internal/view/menu/g$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 66
    sget v1, Lcom/tencent/mm/a$d;->ano:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v0

    iput-boolean v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jU:Z

    .line 68
    sget-object v0, Lcom/tencent/mm/a$o;->dAx:[I
    ...
    .line 70
    sget v1, Lcom/tencent/mm/a$o;->dAy:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jW:I
    ...
    iput v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jX:I
...
.method private bx()V
    ...
    .line 135
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jI:Ljava/lang/CharSequence;
    ...
    .line 136
    :goto_0
    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jS:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jR:Landroid/support/v7/internal/view/menu/i;

    invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/i;->cm()Z

    move-result v3

    if-eqz v3, :cond_1

    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jU:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jV:Z
...
# virtual methods
.method public final a(Landroid/support/v7/internal/view/menu/g$b;)V
    .locals 0

    .prologue
    .line 110
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jT:Landroid/support/v7/internal/view/menu/g$b;
...
.method public final a(Landroid/support/v7/internal/view/menu/i;)V
    ...
    .line 93
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jR:Landroid/support/v7/internal/view/menu/i;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jS:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->bx()V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jI:Ljava/lang/CharSequence;
    ...
    .line 97
    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/i;->getItemId()I
...
.method public final bv()Landroid/support/v7/internal/view/menu/i;
    ...
    .prologue
    .line 89
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jR:Landroid/support/v7/internal/view/menu/i;
...
.method public final by()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/i;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 104
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jT:Landroid/support/v7/internal/view/menu/g$b;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jR:Landroid/support/v7/internal/view/menu/i;

    invoke-interface {v0, v1}, Landroid/support/v7/internal/view/menu/g$b;->c(Landroid/support/v7/internal/view/menu/i;)Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 194
    iget-object v9, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jR:Landroid/support/v7/internal/view/menu/i;

    invoke-virtual {v9}, Landroid/support/v7/internal/view/menu/i;->getTitle()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jX:I
    ...
    iget v4, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jW:I
    ...
    iget v2, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jW:I
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jS:Landroid/graphics/drawable/Drawable;
    ...
    .line 233
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jS:Landroid/graphics/drawable/Drawable;
    ...
    .line 220
    :cond_3
    iget v0, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jW:I
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 84
    iput p1, p0, Landroid/support/v7/internal/view/menu/ActionMenuItemView;->jX:I
