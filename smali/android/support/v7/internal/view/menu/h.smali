...
.field private lD:Landroid/app/AlertDialog;

.field lE:Landroid/support/v7/internal/view/menu/f;
...
.method public constructor <init>(Landroid/support/v7/internal/view/menu/g;)V
    ...
    .line 45
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/h;->ii:Landroid/support/v7/internal/view/menu/g;
...
.method public final a(Landroid/support/v7/internal/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/h;->ii:Landroid/support/v7/internal/view/menu/g;
    ...
    .line 157
    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/h;->lF:Landroid/support/v7/internal/view/menu/o$a;
...
.method public final cc()V
    ...
    sget v3, Lcom/tencent/mm/a$j;->bQH:I

    sget v4, Lcom/tencent/mm/a$n;->dzL:I

    invoke-direct {v2, v3, v4}, Landroid/support/v7/internal/view/menu/f;-><init>(II)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/h;->lE:Landroid/support/v7/internal/view/menu/f;

    .line 65
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/h;->lE:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v2, p0}, Landroid/support/v7/internal/view/menu/f;->a(Landroid/support/v7/internal/view/menu/o$a;)V

    .line 66
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/h;->ii:Landroid/support/v7/internal/view/menu/g;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/h;->lE:Landroid/support/v7/internal/view/menu/f;
    ...
    .line 70
    iget-object v2, v0, Landroid/support/v7/internal/view/menu/g;->lv:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/h;->lD:Landroid/app/AlertDialog;

    .line 84
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/h;->lD:Landroid/app/AlertDialog;
    ...
    .line 76
    :cond_0
    iget-object v2, v0, Landroid/support/v7/internal/view/menu/g;->lu:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v0, Landroid/support/v7/internal/view/menu/g;->lt:Ljava/lang/CharSequence;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 171
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/h;->ii:Landroid/support/v7/internal/view/menu/g;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/h;->lE:Landroid/support/v7/internal/view/menu/f;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 100
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/h;->lD:Landroid/app/AlertDialog;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/view/menu/g;->o(Z)V
