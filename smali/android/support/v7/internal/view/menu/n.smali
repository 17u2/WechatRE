...
.field private lF:Landroid/support/v7/internal/view/menu/o$a;

.field private mContext:Landroid/content/Context;

.field private me:Landroid/support/v7/internal/widget/ListPopupWindow;
...
.field private mj:Landroid/support/v7/internal/view/menu/n$a;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 51
    sget v0, Lcom/tencent/mm/a$j;->bQJ:I

    sput v0, Landroid/support/v7/internal/view/menu/n;->md:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/g;Landroid/view/View;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/n;->he:Landroid/view/LayoutInflater;

    .line 82
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/n;->ii:Landroid/support/v7/internal/view/menu/g;

    .line 83
    iput-boolean p4, p0, Landroid/support/v7/internal/view/menu/n;->mh:Z
    ...
    iput v0, p0, Landroid/support/v7/internal/view/menu/n;->mf:I

    .line 89
    iput-object p3, p0, Landroid/support/v7/internal/view/menu/n;->mg:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/internal/view/menu/n;)Z
    ...
    .prologue
    .line 45
    iget-boolean v0, p0, Landroid/support/v7/internal/view/menu/n;->mh:Z
...
.method static synthetic b(Landroid/support/v7/internal/view/menu/n;)Landroid/view/LayoutInflater;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->he:Landroid/view/LayoutInflater;
...
.method static synthetic c(Landroid/support/v7/internal/view/menu/n;)Landroid/support/v7/internal/view/menu/g;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->ii:Landroid/support/v7/internal/view/menu/g;
...
.method public final a(Landroid/support/v7/internal/view/menu/g;Z)V
    ...
    .line 268
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->lF:Landroid/support/v7/internal/view/menu/o$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/o$a;)V
    ...
    .prologue
    .line 230
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/n;->lF:Landroid/support/v7/internal/view/menu/o$a;
...
.method public final a(Landroid/support/v7/internal/view/menu/s;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/n;->mg:Landroid/view/View;
    ...
    iput-object v0, v3, Landroid/support/v7/internal/view/menu/n;->lF:Landroid/support/v7/internal/view/menu/o$a;
    ...
    .line 248
    :goto_1
    iput-boolean v0, v3, Landroid/support/v7/internal/view/menu/n;->kZ:Z

    .line 250
    invoke-virtual {v3}, Landroid/support/v7/internal/view/menu/n;->cq()Z
...
.method public final cq()Z
    ...
    sget v5, Lcom/tencent/mm/a$c;->popupMenuStyle:I
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/n;->me:Landroid/support/v7/internal/widget/ListPopupWindow;

    .line 110
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->me:Landroid/support/v7/internal/widget/ListPopupWindow;
    ...
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/n;->ii:Landroid/support/v7/internal/view/menu/g;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/n;->mj:Landroid/support/v7/internal/view/menu/n$a;

    .line 114
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->me:Landroid/support/v7/internal/widget/ListPopupWindow;

    iget-object v4, p0, Landroid/support/v7/internal/view/menu/n;->mj:Landroid/support/v7/internal/view/menu/n$a;
    ...
    .line 119
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->mi:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Landroid/support/v7/internal/view/menu/n;->mi:Landroid/view/ViewTreeObserver;
    ...
    .line 129
    iget-object v7, p0, Landroid/support/v7/internal/view/menu/n;->me:Landroid/support/v7/internal/widget/ListPopupWindow;

    iget-object v8, p0, Landroid/support/v7/internal/view/menu/n;->mj:Landroid/support/v7/internal/view/menu/n$a;
    ...
    :goto_2
    iget-object v4, p0, Landroid/support/v7/internal/view/menu/n;->mk:Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, Landroid/support/v7/internal/view/menu/n;->mk:Landroid/view/ViewGroup;
    ...
    .line 129
    :cond_4
    iget v0, p0, Landroid/support/v7/internal/view/menu/n;->mf:I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ListPopupWindow;->da()V
...
.method public final m(Z)V
    ...
    .prologue
    .line 223
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->mj:Landroid/support/v7/internal/view/menu/n$a;
...
.method public onDismiss()V
    ...
    .line 143
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/n;->me:Landroid/support/v7/internal/widget/ListPopupWindow;
    ...
    .line 147
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/n;->mg:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/n;->mi:Landroid/view/ViewTreeObserver;
    ...
    .line 150
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/n;->mi:Landroid/view/ViewTreeObserver;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/internal/view/menu/n$a;->D(I)Landroid/support/v7/internal/view/menu/i;
