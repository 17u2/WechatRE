.class final Landroid/support/v7/internal/widget/ActionBarView$a;
...
.field nD:Landroid/support/v7/internal/view/menu/i;
...
.method private constructor <init>(Landroid/support/v7/internal/widget/ActionBarView;)V
    ...
    .prologue
    .line 1367
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nC:Landroid/support/v7/internal/widget/ActionBarView;
...
.method public final a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/g;)V
    ...
    .prologue
    .line 1375
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->ii:Landroid/support/v7/internal/view/menu/g;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nD:Landroid/support/v7/internal/view/menu/i;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nD:Landroid/support/v7/internal/view/menu/i;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/g;->g(Landroid/support/v7/internal/view/menu/i;)Z

    .line 1378
    :cond_0
    iput-object p2, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->ii:Landroid/support/v7/internal/view/menu/g;
...
.method public final d(Landroid/support/v7/internal/view/menu/i;)Z
    ...
    .line 1430
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nC:Landroid/support/v7/internal/widget/ActionBarView;

    invoke-virtual {p1}, Landroid/support/v7/internal/view/menu/i;->getActionView()Landroid/view/View;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v7/internal/widget/ActionBarView;->nx:Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nC:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nC:Landroid/support/v7/internal/widget/ActionBarView;
    ...
    .line 1432
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nD:Landroid/support/v7/internal/view/menu/i;

    .line 1433
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nC:Landroid/support/v7/internal/widget/ActionBarView;

    iget-object v0, v0, Landroid/support/v7/internal/widget/ActionBarView;->nx:Landroid/view/View;
    ...
    iget-object v1, v1, Landroid/support/v7/internal/widget/ActionBarView;->nx:Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/v7/internal/widget/ActionBarView;->i(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/q;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/internal/widget/q;->setVisibility(I)V
    ...
    .line 1453
    invoke-virtual {p1, v4}, Landroid/support/v7/internal/view/menu/i;->u(Z)V
...
.method public final e(Landroid/support/v7/internal/view/menu/i;)Z
    ...
    iput-object v3, v0, Landroid/support/v7/internal/widget/ActionBarView;->nx:Landroid/view/View;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/q;->setVisibility(I)V
    ...
    .line 1493
    iput-object v3, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nD:Landroid/support/v7/internal/view/menu/i;
    ...
    .line 1495
    invoke-virtual {p1, v2}, Landroid/support/v7/internal/view/menu/i;->u(Z)V
...
.method public final m(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/g;->size()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/view/menu/g;->getItem(I)Landroid/view/MenuItem;
    ...
    .line 1396
    iget-object v4, p0, Landroid/support/v7/internal/widget/ActionBarView$a;->nD:Landroid/support/v7/internal/view/menu/i;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/internal/widget/ActionBarView$a;->e(Landroid/support/v7/internal/view/menu/i;)Z
