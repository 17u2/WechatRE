...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 47
    sget-object v1, Lcom/tencent/mm/a$o;->dCf:[I
    ...
    .line 49
    sget v2, Lcom/tencent/mm/a$o;->dCg:I

    invoke-virtual {v1, v2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pa:Landroid/graphics/drawable/Drawable;

    .line 50
    iget-object v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pa:Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pb:I
    ...
    iput v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pc:I

    .line 57
    :goto_0
    sget v2, Lcom/tencent/mm/a$o;->dCi:I

    invoke-virtual {v1, v2, v0}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pd:I

    .line 58
    sget v2, Lcom/tencent/mm/a$o;->dCh:I

    invoke-virtual {v1, v2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pe:I

    .line 60
    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    .line 62
    iget-object v1, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pa:Landroid/graphics/drawable/Drawable;
    ...
    .line 54
    :cond_1
    iput v0, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pb:I

    iput v0, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pc:I
...
.method private a(Landroid/graphics/Canvas;I)V
    ...
    .prologue
    .line 149
    iget-object v0, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pa:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/support/v7/internal/widget/LinearLayoutICS;->getPaddingLeft()I

    move-result v1

    iget v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pe:I
    ...
    iget v3, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pe:I

    sub-int/2addr v2, v3

    iget v3, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pc:I
...
.method private b(Landroid/graphics/Canvas;I)V
    ...
    iget v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pb:I
    ...
    iget v4, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pe:I
...
.method protected A(I)Z
    ...
    .line 169
    iget v2, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pd:I
...
.method protected measureChildWithMargins(Landroid/view/View;IIII)V
    ...
    .line 87
    iget v1, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pc:I
    ...
    .line 93
    iget v1, p0, Landroid/support/v7/internal/widget/LinearLayoutICS;->pb:I
